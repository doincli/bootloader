...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/test12.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=mcc_generated_files/pin_manager.c mcc_generated_files/device_config.c mcc_generated_files/interrupt_manager.c mcc_generated_files/pwm6.c main.c mcc_generated_files/tmr2.c mcc_generated_files/mcc.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mcc_generated_files/pin_manager.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/device_config.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/interrupt_manager.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/pwm6.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/main.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/tmr2.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/mcc.${OUTPUT_EXTENSION_C}
POSSIBLE_DEPFILES=${OBJECTDIR}/mcc_generated_files/pin_manager.${OUTPUT_EXTENSION_C}.d ${OBJECTDIR}/mcc_generated_files/device_config.${OUTPUT_EXTENSION_C}.d ${OBJECTDIR}/mcc_generated_files/interrupt_manager.${OUTPUT_EXTENSION_C}.d ${OBJECTDIR}/mcc_generated_files/pwm6.${OUTPUT_EXTENSION_C}.d ${OBJECTDIR}/main.${OUTPUT_EXTENSION_C}.d ${OBJECTDIR}/mcc_generated_files/tmr2.${OUTPUT_EXTENSION_C}.d ${OBJECTDIR}/mcc_generated_files/mcc.${OUTPUT_EXTENSION_C}.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mcc_generated_files/pin_manager.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/device_config.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/interrupt_manager.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/pwm6.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/main.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/tmr2.${OUTPUT_EXTENSION_C} ${OBJECTDIR}/mcc_generated_files/mcc.${OUTPUT_EXTENSION_C}

# Source Files
SOURCEFILES=mcc_generated_files/pin_manager.c mcc_generated_files/device_config.c mcc_generated_files/interrupt_manager.c mcc_generated_files/pwm6.c main.c mcc_generated_files/tmr2.c mcc_generated_files/mcc.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/test12.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/mcc_generated_files/pwm6.${OUTPUT_EXTENSION_C}: mcc_generated_files/pwm6.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/mcc_generated_files" 
	@${RM} ${OBJECTDIR}/mcc_generated_files/pwm6.${OUTPUT_EXTENSION_C}.d 
	@${RM} ${OBJECTDIR}/mcc_generated_files/pwm6.${OUTPUT_EXTENSION_C} 
	 -D__DEBUG=1    -fno-short-double -fno-short-float ${code-model-external.prefix}wordwrite ${optimization-options.prefix}${disable-optimizations.true} ${what-to-do.prefix}ignore ${preprocess-assembler.trueemission} -N255 ${warn-level.prefix}-3 ${asmlist.true} -D=$(CND_CONF)  ${linker-report-options.prefix}-psect${linker-report-options.separator}-class${linker-report-options.separator}+mem${linker-report-options.separator}-hex${linker-report-options.separator}-file ${ld-extra.prefix}${ld-extra.false} ${linker-runtime-options.prefix}+clear${linker-runtime-options.separator}${initialize-data.true}${linker-runtime-options.separator}${keep-generated-startup.as.false}${linker-runtime-options.separator}${opt-xc8-linker-link_startup.false}${linker-runtime-options.separator}${calibrate-oscillator.false}${linker-runtime-options.separator}${backup-reset-condition-flags.false}${linker-runtime-options.separator}${format-hex-file-for-download.false}${linker-runtime-options.separator}${managed-stack.false}${linker-runtime-options.separator}${program-the-device-with-default-config-words.true}${linker-runtime-options.separator}-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs ${stack-options.prefix}compiled    mcc_generated_files/pwm6.c 
...
${OBJECTDIR}/mcc_generated_files/tmr2.${OUTPUT_EXTENSION_C}: mcc_generated_files/tmr2.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/mcc_generated_files" 
	@${RM} ${OBJECTDIR}/mcc_generated_files/tmr2.${OUTPUT_EXTENSION_C}.d 
	@${RM} ${OBJECTDIR}/mcc_generated_files/tmr2.${OUTPUT_EXTENSION_C} 
	 -D__DEBUG=1    -fno-short-double -fno-short-float ${code-model-external.prefix}wordwrite ${optimization-options.prefix}${disable-optimizations.true} ${what-to-do.prefix}ignore ${preprocess-assembler.trueemission} -N255 ${warn-level.prefix}-3 ${asmlist.true} -D=$(CND_CONF)  ${linker-report-options.prefix}-psect${linker-report-options.separator}-class${linker-report-options.separator}+mem${linker-report-options.separator}-hex${linker-report-options.separator}-file ${ld-extra.prefix}${ld-extra.false} ${linker-runtime-options.prefix}+clear${linker-runtime-options.separator}${initialize-data.true}${linker-runtime-options.separator}${keep-generated-startup.as.false}${linker-runtime-options.separator}${opt-xc8-linker-link_startup.false}${linker-runtime-options.separator}${calibrate-oscillator.false}${linker-runtime-options.separator}${backup-reset-condition-flags.false}${linker-runtime-options.separator}${format-hex-file-for-download.false}${linker-runtime-options.separator}${managed-stack.false}${linker-runtime-options.separator}${program-the-device-with-default-config-words.true}${linker-runtime-options.separator}-plib $(COMPARISON_BUILD)  --output=-mcof,+elf:multilocs ${stack-options.prefix}compiled    mcc_generated_files/tmr2.c 
